            ...
            <div className="col-xl-2 col-lg-2 col-md-2 col-sm-3 col-xs-3 col-2 p-0">
              <div className="h-100 d-flex flex-column">
                <div className="row m-2 py-2">
                  <i className="m-0 fab fa-twitter fa-2x" id="twitter-blue"></i>
                </div>
                <div className="row hover-class align-items-center m-2 py-1" onClick={this.handleAllTweets} id={this.state.userTweetsOnly ? "" : "twitter-blue"}>
                  <i className="mr-3 fas fa-home fa-2x"></i>
                  <button className="btn bg-transparent"><span className="m-0 font-weight-bold h5" id={this.state.userTweetsOnly ? "" : "twitter-blue"}>Home</span></button>
                </div>
                <div className="row hover-class align-items-center m-2 py-1" onClick={this.handleUserTweetsOnly} id={this.state.userTweetsOnly ? "twitter-blue" : ""}>
                  <i className="mr-3 fas fa-user-friends fa-2x"></i>
                  <button className="btn bg-transparent"><span className="m-0 font-weight-bold h5" id={this.state.userTweetsOnly ? "twitter-blue" : ""}>Profile</span></button>
                </div>
